...
export type SettingsContentProps = Omit<LeftPanelProps, 'isOpen' | 'onToggle'>;
        ...
        <div className="space-y-4">
          ...
          {showProfile && (
            <div>
              ...
              <select
                value={profileStat}
                onChange={(e) => setProfileStat(e.target.value as SettingsContentProps['profileStat'])}
      ...
      <ControlSection title="Sorting & Filter" defaultOpen={false}>
        <div className="space-y-4">
          <div>
            ...
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value as SettingsContentProps['sortBy'])}
